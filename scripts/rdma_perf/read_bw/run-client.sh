...
taskset -c 4 ib_read_bw --ib-port=2 --size=32 --run_infinitely --duration=1 --port=$ib_p2_port1 10.113.211.51 &
taskset -c 6 ib_read_bw --ib-port=2 --size=32 --run_infinitely --duration=1 --port=$ib_p2_port2 10.113.211.51 &
